...
for elem in students:
    if elem["course"] =="python":
        python.append(elem['name'])
    elif elem["course"] =='java':
        java.append(elem['name'])
    elif elem ["course"]=="javascript":
        javascript.append(elem['name'])
    
courses={'python':python,'java':java,'javascript':javascript}
print(courses)
...
def func(names,names_ages):
    for elem in names :
        try:
            ...
            print(f'Имени{elem} не существует в словаре !')
